...
Minimal [Next.js](https://nextjs.org) App Router app with a placeholder `did:web` identity, `llms.txt`, Cursor rules, and [`@trustflow/next-plugin`](../../packages/next-plugin/README.md).
...
From this monorepo, `starters/nextjs` can run the local binary. That is not the product install.
