...
export function createAgenticTrustMcpServer(options = {}) {
    ...
    server.registerTool("generate_did_keys", {
        ...
        description: "Generate an Ed25519 (default) or ES256 (P-256) key pair and a signed W3C did:web document for /.well-known/did.json. Signing uses @trustflow/sdk createSignedDidDocument. Returns did.json plus privateKeyPem, labeled SECRET. The private key is not written unless privateKeyPath is set.",
        inputSchema: {
