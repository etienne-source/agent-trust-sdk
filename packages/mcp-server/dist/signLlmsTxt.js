 ...
 */
export async function signLlmsTxt(input) {
...
async function readLlmsSource(input) {
    const inline = input.llmsTxt;
    if (typeof inline === "string") {
        if (!inline.trim())
            throw new Error("llmsTxt is empty. Pass the manifest body or llmsTxtPath.");
        return inline;
    }
...
function algorithmOfPrivateKey(pem) {
    let key;
    try {
...
async function writePublicArtifacts(outputDir, llmsTxt, didJson) {
...
//# sourceMappingURL=signLlmsTxt.js.map